module.exports = {
    ...
    author: "@exhlim",
    siteTitle: "Eugene Lim",
    siteShortTitle: "Portfolio Website", // Used as logo text in header, footer, and splash screen
    siteDescription: "Eugene Lim's Portfolio Website",
